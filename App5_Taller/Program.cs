...
namespace App5_Taller
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Instancia
            Taller_Mecanico objTallerM = new Taller_Mecanico();
            double Cobro;
                    ...
                    case ConsoleKey.A:
                        {
                            ...
                            //La capacidad es 7, se escribe 6 por las posiciones en las listas
                            if (objTallerM.CAPACIDAD > 6)
                            {
